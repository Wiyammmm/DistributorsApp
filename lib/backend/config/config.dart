class Config {
  ...
  static const getBankIdUrl =
      "http://172.232.77.205:3003/api/v1/distributor/bankid";

  static const sandboxUrl = "https://direct.sandbox.bnk.to/v1/checkout";
  static const sandboxUrlLive = "https://direct.bnk.to/v1/checkout";
  static const registerUserUrl =
      "http://172.232.77.205:3003/api/v1/distributor/user";

  static const checkRefNumUrl =
      "http://172.232.77.205:3003/api/v1/distributor/user/checkReferenceNumber/";
